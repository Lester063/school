    ...
    <div class="container bg-light">
        <div class="row mt-5 "id="home">
            ...
            <div class="col-5 bg-light mt-5 mb-5">
                <img src="../imageResources/aceImage.jpg" style="width:100%;height:100%;">
            </div>

        </div>

        <div class="row bg-light border-top border-secondary border-5"id="courses">
            <h1 class="mt-5">What courses we offer?</h1>
            <h4>Here are the courses we offer.</h4>
            <?php
        ...
        <div class="row bg-light border-top border-secondary border-5 mt-5"id="news">
                <h1 class="mt-5">Our news</h1>
                <?php
                ...
                <div class="col-sm-4">
                    ...
                    <a href="http://localhost/school/outside/news.php?headline=<?php echo $rowNews['headline']?>&news_id=<?php echo $rowNews['news_id']?>">Click here</a>
                </div>
                <?php
                }
                ?>
    ...
    <div class="container-fluid bg-dark text-white">
        <div class="row p-3">
            ...
            <div class="col-3">
                ...
                <b>We are open during weekdays from 7am to 4pm.</b>
            </div>
