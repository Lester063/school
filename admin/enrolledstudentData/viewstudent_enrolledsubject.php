...
$getStudentEnrolled = "SELECT es.*, sub.*,sec.* FROM enrolled_subject es, subject sub, section sec WHERE sec.section_id = es.section_id AND
es.subject_id = sub.subject_id AND student_number = '$student_number' AND es.schoolyear = '$student_schoolyear'";
$result_getStudentEnrolled = mysqli_query($conn, $getStudentEnrolled);

$get_drop_data = "SELECT ad.*, sub.*, sec.* FROM add_drop_subject ad, subject sub,section sec WHERE ad.subject_id = sub.subject_id AND
ad.section_id = sec.section_id AND student_number = '$student_number' AND ad.schoolyear = '$student_schoolyear'";
...
$getAll_subject = "SELECT ss.*, sub.*, sec.*, t.* FROM section_subject ss, subject sub, section sec, teacher t WHERE ss.teacher_id = t.teacher_id
AND ss.subject_id = sub.subject_id AND ss.section_id = sec.section_id AND sec.schoolyear = '$student_schoolyear' ORDER BY section_subjectId ASC";
            ...
            <div class="col-sm-12" id="myDIV">
                ...
                <table class="table">
                    ...
                    <tr id="<?php echo $row['enrolled_subject_id']?>">
                        ...
                        <td>
                            <button onclick="confirm('are you sure?') && dropSubject(<?php echo $row['enrolled_subject_id']?>)"class="redblackButton">
                                DROPPED
                            </button>
                        </td>
                    </tr>
                ...
                <table class="table">
                    ...
                    <tr id="<?php echo $drop_row['enrolled_subject_id']?>">
                        ...
                        <td>
                            <button onclick="confirm('are you sure?') && addAgain_subject(<?php echo $drop_row['enrolled_subject_id']?>)"class="bluewhiteButton">
                                ADD AGAIN
                            </button>
                        </td>
                    </tr>
                ...
                <table class="table">
                    ...
                    <tr>
                        ...
                        <td>
                            <button onclick="confirm('Are you sure?') && adddrop_addSubject(<?php echo $row_subject['section_subjectId']?>)"class="bluewhiteButton">
                                Add
                            </button>
                        </td>
                    </tr>
