...
$adviser = mysqli_fetch_array(mysqli_query($conn, "SELECT ad.*, t.* FROM advisers ad, teacher t WHERE t.teacher_id = ad.adviser_id AND
section_id = '$getSection_id' AND schoolyear_assign = '$getSchoolyear'"));
?>
