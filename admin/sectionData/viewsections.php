...
<td><button type="button" class="deletebutton"name="button" onclick = "confirm('Are you sure ?') && deleteSection(<?php echo $rowsection['section_id']; ?>);">Delete</button>
<button type="button" class="editsectionbutton"name="editbuttonsection"id="<?php echo $rowsection['section_id'];?>" onclick = "editbuttonsection(<?php echo $rowsection['section_id']; ?>);">Edit Data</button></td> 
</tr>
