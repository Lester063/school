...
<?Php require_once('updateadminform.php') ?>
	...
	<div class="col-sm-7">
        <table class="myTable">
            <tr>
                <td colspan=2>PROFILE<button type="button" class="adminEdit bluewhiteButton"name="nimal" id="<?php echo $_SESSION['admin_id'] ?>"onclick="adminEditForm(<?php echo $admin_id?>)">Edit Data</button></td>
            </tr>
            <tr>
                <td>Firstname</td>
